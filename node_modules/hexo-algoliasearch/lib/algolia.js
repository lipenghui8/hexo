...
exports.default = exports.getFieldsWithFilters = exports.getBasicFields = exports.preparePosts = exports.splitIntoChunks = exports.upperFirst = exports.pick = void 0;
...
function () {
  var _ref = _asyncToGenerator(function* (hexo, args, callback) {
    ...
    const algoliaIndexName = process.env.ALGOLIA_INDEX_NAME || algoliaConfig.indexName; // Algolia recommendation: split posts into chunks of 5000 to get a good indexing/insert performance
