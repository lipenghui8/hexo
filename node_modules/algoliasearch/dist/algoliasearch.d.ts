...
export declare type SearchClient = SearchClient_2 & {
    ...
    readonly addApiKey: (acl: readonly string[], requestOptions?: AddApiKeyOptions & Pick<RequestOptions, Exclude<keyof RequestOptions, 'queryParameters'>>) => Readonly<WaitablePromise<AddApiKeyResponse>>;
